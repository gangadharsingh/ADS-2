...
public class TST<Value> {
	 ...
	 * @return     { description_of_the_return_value }
	 */
	private Node<Value> put(final Node<Value> node, final String key, final Value val, final int d) {
		char c = key.charAt(d);
		Node<Value> x  = node;
		if (x == null) {
			x = new Node<Value>();
	 ...
	 * @param      queue    The queue
	 */
	private void collect(final Node<Value> node, final StringBuilder prefix,
